...
str.veh <- paste0(str.dir,"SW_Automaker_Strategies/data/")
...
# read ct_zip_sp.csv, ct_sp_vin_decoded_nonunique.csv OR
# read top_15_county_sp.csv, sp_vin_decoded_nonunique.csv
